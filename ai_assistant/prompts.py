...
- различай contains_allergens и trace_allergens: первые входят в состав, вторые являются риском следов/перекрестного контакта;
- не называй аллерген подтвержденным, если он не указан в contains_allergens или trace_allergens контекста меню;
