...
class MenuRenderingTests(TestCase):
    ...
    def test_seasonal_carousel_indicator_is_runtime_driven(self):
        ...
        compact_seasonal_css_path = finders.find("css/menu-compact-seasonal.css")
        compact_controls_css_path = finders.find("css/menu-compact-controls.css")
        compact_hero_css_path = finders.find("css/menu-compact-hero.css")
        compact_layout_css_path = finders.find("css/menu-compact-layout.css")
        legacy_compact_css_path = finders.find("css/menu-responsive-compact.css")
        ...
        self.assertIsNotNone(compact_seasonal_css_path)
        self.assertIsNotNone(compact_controls_css_path)
        self.assertIsNotNone(compact_hero_css_path)
        self.assertIsNotNone(compact_layout_css_path)
        self.assertIsNotNone(legacy_compact_css_path)
        ...
        compact_seasonal_css_source = Path(compact_seasonal_css_path).read_text(encoding="utf-8")
        compact_controls_css_source = Path(compact_controls_css_path).read_text(encoding="utf-8")
        compact_hero_css_source = Path(compact_hero_css_path).read_text(encoding="utf-8")
        compact_layout_css_source = Path(compact_layout_css_path).read_text(encoding="utf-8")
        legacy_compact_css_source = Path(legacy_compact_css_path).read_text(encoding="utf-8")
        ...
        self.assertIn('@import url("menu-compact-seasonal.css");', manifest_source)
        self.assertIn('@import url("menu-compact-controls.css");', manifest_source)
        self.assertIn('@import url("menu-compact-hero.css");', manifest_source)
        self.assertIn('@import url("menu-compact-layout.css");', manifest_source)
        self.assertNotIn('@import url("menu-responsive-compact.css");', manifest_source)
        ...
        self.assertIn("Compact responsive seasonal layer", compact_seasonal_css_source)
        self.assertIn(".seasonal-card", compact_seasonal_css_source)
        self.assertIn("Compact responsive search/category controls layer", compact_controls_css_source)
        self.assertIn(".menu-controls", compact_controls_css_source)
        self.assertIn(".category-strip", compact_controls_css_source)
        self.assertIn("Compact responsive hero/header layer", compact_hero_css_source)
        self.assertIn(".menu-hero", compact_hero_css_source)
        self.assertIn("Compact responsive menu layout guardrails", compact_layout_css_source)
        self.assertIn(".dish-grid", compact_layout_css_source)
        self.assertNotIn(".menu-controls", compact_seasonal_css_source)
        self.assertNotIn(".seasonal-card", compact_controls_css_source)
        self.assertNotIn(".seasonal-card", compact_hero_css_source)
        self.assertNotIn(".menu-controls", compact_hero_css_source)
        self.assertNotIn(".menu-hero", compact_seasonal_css_source)
        self.assertNotIn(".seasonal-card", legacy_compact_css_source)
        self.assertNotIn(".menu-controls", legacy_compact_css_source)
        self.assertNotIn(".menu-hero", legacy_compact_css_source)
    ...
    def test_menu_uses_split_sticky_controller_with_compact_fixed_panel(self):
        loader_path = finders.find("js/menu-ui-loader.js")
        ...
        self.assertIn("setupCompact", sticky_source)
        self.assertIn("is-sticky-search-enhanced", sticky_source)
        self.assertIn("is-compact-sticky", sticky_source)
        self.assertIn("menu-controls-placeholder", sticky_source)
        self.assertIn("--menu-compact-left", sticky_source)
        ...
        self.assertIn("@media (max-width: 959px)", css_source)
        self.assertIn(".menu-controls.is-compact-sticky", css_source)
        self.assertIn("position: fixed", css_source)
        self.assertIn(".menu-controls.is-compact-sticky.is-search-hidden .menu-search-panel", css_source)
