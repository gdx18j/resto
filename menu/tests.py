...
class MenuRenderingTests(TestCase):
    ...
    def test_menu_uses_split_sticky_controller_with_mobile_fixed_panel(self):
        ...
        self.assertNotIn("placeholder.hidden = false", sticky_source)
        self.assertNotIn("releaseDistance", sticky_source)
        self.assertNotIn("downDistance", sticky_source)
        self.assertNotIn("hideDistance", sticky_source)
        ...
        mobile_css_source = css_source[
            css_source.find("@media (max-width: 619px)"):
            css_source.find(".preference-note")
        ]
        mobile_sticky_source = sticky_source[
            sticky_source.find("function setupMobile"):
            sticky_source.find("function setup()")
        ]
        ...
        self.assertIn("position: relative", mobile_css_source)
        self.assertNotIn("position: fixed", mobile_css_source)
        self.assertNotIn("position: sticky", mobile_css_source)
        self.assertIn("height: auto", mobile_css_source)
        ...
        self.assertNotIn("contain: layout paint", mobile_css_source)
        self.assertNotIn('on(window, "scroll"', mobile_sticky_source)
